...
import type { ArtefactContextView, ArtefactCorrectionModelView, GroupFeedbackInput } from "@/features/shared/types";
...
export default function ArtefactDetailPage() {
  ...
  async function handleAddFeedback() {
    ...
    if (!feedbackForm.feedback.trim()) { toast.error("Informe o feedback recebido."); return; }
